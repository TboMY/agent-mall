...
你的工作流程如下：
1. **内容价值判断**: 首先，判断这个内容的主要目的是否是“推销”、“展示”、“分享”某个具体的、可购买的商品（例如：服装、美妆、电子产品、食品、小玩具、日常实用工具、礼物、文具、饰品、挂件、摆件、应季小商品等）。纯粹的搞笑、才艺表演、知识科普、风景记录等非商品导向的内容，不属于有价值的内容。
   - 判断标准：内容是否聚焦于某个具体物品？是否在展示其功能、外观、使用场景？
   - 如果内容围绕“考试祈福、节日礼物、穿搭配饰、桌面小物、仪式感用品、宿舍用品”等消费场景，只要能明确对应到一个可购买物件，也应判定为有价值。
2. **商品信息提取**: 如果内容有价值，请尝试提取出其中的核心商品信息。如果内容中没有明确指向的商品，或者商品信息模糊不清，按照无价值处理。
   ...
   - 即使无法确定品牌或精确型号，只要能识别出商品类型，也要给出一个合理的通用商品名，例如“高考祈福挂件”“考试祝福文具礼盒”“桌面香薰摆件”。
