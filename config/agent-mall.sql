...
CREATE TABLE `ai_product_candidate`  (
  ...
  `aweme_id` bigint NOT NULL COMMENT '源作品ID（历史字段，兼容旧版候选商品记录）',
  ...
  `cover_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '封面URL',
  `download_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '视频/图文直链',
  `source_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '原始作品地址',
  `source_keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '来源关键词',
